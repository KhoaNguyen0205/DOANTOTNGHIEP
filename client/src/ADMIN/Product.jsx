                        ...
                        {addPrd ? (
                            ...
                            <div className="admin-product-manage">
                                <div className="admin-product-nav">
                                    <div className="admin-product-nav-item">Sneaker</div>
                                    <div className="admin-product-nav-item">Clothes</div>
                                    <div className="admin-product-nav-item">Accessories</div>
                                </div >
                                <div className="admin-list-product">
                                    {products.length > 0 && products.map(product => (
                                        <div key={product} className="admin-product">
                                            {product.name} <br />
                                            {product.quantity} <br />
                                            {new Date(product.createdAt).toLocaleString()} <br />
